...
// then on doc ready, it is cached:
ich.addTemplate("user", '<li><p class="name">Hello I\'m {{ name }}</p><p><a href="http://twitter.com/{{ twitter }}">@{{ twitter }}</a></p></li>');
console.log(ich.user);
...
ich.addTemplate("welcome", '<p>Welcome, {{name}}! {{>winnings}}</p>');

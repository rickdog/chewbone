...
s.setAttribute('href', 'http://codemirror.net/lib/codemirror.css');
...
var myCodeMirror = CodeMirror.fromTextArea(myTextArea, {mode: {name: "javascript"}, value: "var xxx=123;\n"});
var len = $("p").length;
for (i = 0; i < len; i++)
   myCodeMirror.setValue(myCodeMirror.getValue() + $("p")[i].innerHTML);
   myCodeMirror.setValue(document.body.innerHTML);
